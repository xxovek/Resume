  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <!-- <a href="formatpdf.php" class="btn btn-dark" role="button">DOWNLOAD CV</a> -->
        ...
        <!-- <button type="button" class="btn btn-dark">DOWNLOAD CV</button> -->
    <!-- <a href="dashboard.php" class="btn btn-secondary" role="button">BACK</a> -->
    <!-- </div> -->
      </ul>
...
<section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      ...
      <div class="w-100">
        <h3 class="mb-0">Sonali
          <span class="text-primary">Bhagwat</span>
        </h3>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="awards">
      <div class="w-100">
        <h5 class="mb-5">Awards &amp; Certifications</h5>
        <ul class="fa-ul mb-0">
          <li>
